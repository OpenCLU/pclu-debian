  ...
  LINE(208);
    ...
    T_1_1.num = size.num + 8;
     if ((T_1_1.num > 0 && size.num < 0 && 8 < 0) || 
        ...
        err = ERR_overflow;
        goto ex_0;}
    err = intOPdiv(T_1_1, CLU_8, &T_1_2);
    if (err != ERR_ok) goto ex_0;
  ...
  LINE(226);
    {
        ...
        err = gcbOPget_size(ch, &T_1_1);
        if (err != ERR_ok) goto ex_0;
        T_1_2.num = T_1_1.num - 16;
         if ((T_1_2.num >= 0 && T_1_1.num < 0 && (-16) < 0) || 
             (T_1_2.num <= 0 && T_1_1.num > 0 && (-16) > 0)) {
            err = ERR_overflow;
            goto ex_0;}
        size.num = T_1_2.num;
        }
...
CLUREF *ret_1;
  ...
  LINE(328);
    ...
    T_1_1.num = gcbOPlook_count.num - 8;
     if ((T_1_1.num >= 0 && gcbOPlook_count.num < 0 && (-8) < 0) || 
         (T_1_1.num <= 0 && gcbOPlook_count.num > 0 && (-8) > 0)) {
        err = ERR_overflow;
        goto ex_0;}
...
CLUREF b;
  ...
  LINE(338);
    {
        ...
        err = intOPdiv(T_1_1, CLU_8, &T_1_2);
        if (err != ERR_ok) goto ex_0;
        err = intOPmul(T_1_2, CLU_8, &T_1_3);
        if (err != ERR_ok) goto ex_0;
  ...
  LINE(347);
        ...
        T_2_1.num = gcbOPlook_index.num - 1;
         if ((T_2_1.num >= 0 && gcbOPlook_index.num < 0 && (-1) < 0) || 
            ...
            err = ERR_overflow;
            goto ex_0;}
        err = intOPmul(T_2_1, CLU_8, &T_2_2);
        if (err != ERR_ok) goto ex_0;
        T_2_3.num = T_2_2.num + 1;
  ...
  LINE(349);
        ...
        CLUREF T_2_1;
        CLUREF T_2_2;
        err = intOPdiv(count, CLU_8, &T_2_1);
        if (err != ERR_ok) goto ex_0;
